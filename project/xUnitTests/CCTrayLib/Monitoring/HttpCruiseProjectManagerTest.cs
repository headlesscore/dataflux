...
namespace ThoughtWorks.CruiseControl.UnitTests.CCTrayLib.Monitoring
{
    ...
    <Queues>
        ...
        [Fact(DisplayName="Fix build not currently supported on projects monitored via HTTP")]
        public void FixBuildThrowsAnNotImplementedException()
        {
            Assert.Throws<NotImplementedException>(delegate { manager.FixBuild(null, "John Do"); });
            Assert.Throws<NotImplementedException>(delegate { manager.FixBuild(null, "John Do"); });
        }

        [Fact(DisplayName="Cancel pending not currently supported on projects monitored via HTTP")]
        public void CancelPendingRequestThrowsAnNotImplementedException()
        {
            Assert.Throws<NotImplementedException>(delegate { manager.CancelPendingRequest(null); });
        }
	}
}
