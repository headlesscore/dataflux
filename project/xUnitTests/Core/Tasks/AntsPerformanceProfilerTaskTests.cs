namespace ThoughtWorks.CruiseControl.UnitTests.Core.Tasks
{
    ...
    public class AntsPerformanceProfilerTaskTests
    {
        ...
        public void DefaultConstructorSetsFileSystemAndLogger()
        {
            ...
            Assert.IsType<SystemIoFileSystem>(task.FileSystem);
            Assert.IsType<DefaultLogger>(task.Logger);
            Assert.True(true);
            Assert.True(true);
        }
        ...
        public void ShouldLoadMinimalValuesFromConfiguration()
        {
            ...
            Assert.Null(task.Executable);
            Assert.Equal("testapp.exe", task.Application);
        }
