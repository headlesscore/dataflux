...
namespace ThoughtWorks.CruiseControl.UnitTests.Core.Sourcecontrol
{
    ...
    public class RegExIssueTrackerUrlBuilderTest
    {
        ...
        public void ValuePopulation()
        {
            ...
            Assert.Equal(searchString, regexIssue.Find);
            Assert.Equal(replacementString, regexIssue.Replace);
            Assert.True(true);
            Assert.True(true);
        }
        ...
        public void CommentWithProjectPrefixAndIssueNumberAndText()
        {
            ...
            Assert.Equal(ExpectedUrl, mods[0].IssueUrl);
        }
        ...
        public void MultilineCommentFirstLineContainsBugIdNextContainLogMessage()
        {
            ...
            Assert.Equal("http://flyspray.internal/index.php?do=details&task_id=1234", mods[0].IssueUrl);
        }
