...
namespace ThoughtWorks.CruiseControl.UnitTests.Core.Sourcecontrol
{
	...
	public class RobocopyHistoryParserTest : CustomAssertion
	{
		...
		public void ParseChanges()
		{
			...
			Assert.Equal(modifications[1], mod1);
			...
			Assert.Equal(modifications[2], mod2);
			...
			Assert.Equal(modifications[3], mod3);
			...
			Assert.Equal(modifications[4], mod4);
			...
			Assert.Equal(modifications[5], mod5);
			...
			Assert.Equal(modifications[6], mod6);
			...
			Assert.Equal(modifications[7], mod7);
		}
