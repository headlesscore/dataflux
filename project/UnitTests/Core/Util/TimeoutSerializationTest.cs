...
namespace ThoughtWorks.CruiseControl.UnitTests.Core.Util
{
	...
	public class TimeoutSerializationTest
	{
		...
		public void MillisAreSerializedWithNoPeriodAttribute()
		{
			...
			ClassicAssert.AreEqual("<timeout>100</timeout>", stringWriter.ToString());
		...
		public void MinutesAreSerializedWithAPeriodAttribute()
		{
			...
			StringWriter stringWriter = new StringWriter();
			serializer.Write(new XmlTextWriter(stringWriter), period);
			ClassicAssert.AreEqual("<timeout units=\"minutes\">100</timeout>", stringWriter.ToString());
		}
		...
		public void CanDeserializeAttributes()
		{
			...
			a.Value = "100";
			ClassicAssert.AreEqual(new Timeout(100, TimeUnits.MILLIS), serializer.Read(a, null));
		}
		...
		public void CanDeserializeAsElements()
		{
			...
			e.InnerText = "100";
			ClassicAssert.AreEqual(new Timeout(100, TimeUnits.MILLIS), serializer.Read(e, null));
		}
		...
		public void CanDeserializeAsElementsWithUnits()
		{
			...
			e.InnerText = "2";
			ClassicAssert.AreEqual(new Timeout(2000, TimeUnits.MILLIS), serializer.Read(e, null));
		}
	}
}
