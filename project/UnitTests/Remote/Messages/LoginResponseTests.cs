...
namespace ThoughtWorks.CruiseControl.UnitTests.Remote.Messages
{
    ...
    public class LoginResponseTests
    {
        ...
        public void GetSetAllPropertiesWorks()
        {
            ...
            ClassicAssert.AreEqual("new token", response.SessionToken, "SessionToken fails get/set test");
        ...
        public void ToStringSerialisesDefaultValues()
        {
            ...
            string expected = string.Format(System.Globalization.CultureInfo.CurrentCulture,"<loginResponse xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" " +
